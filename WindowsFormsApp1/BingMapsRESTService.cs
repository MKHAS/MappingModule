...
namespace BingMapsRESTService
{
    ...
    [DataContract(Namespace = "http://schemas.microsoft.com/search/local/ws/rest/v1", Name = "DistanceMatrix")]
    ...
    public class Response
    {
        ...
        public static implicit operator Response(Telerik.WinControls.UI.Map.Bing.Response v)
        {
    ...
    public class DistanceMatrix : Resource
    {
        ...
        public DistanceResult[] results { get; set; }
    }
